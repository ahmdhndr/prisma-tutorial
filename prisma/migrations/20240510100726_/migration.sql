...
CREATE TABLE "CourseEnrollments" (
    ...
    CONSTRAINT "CourseEnrollments_pkey" PRIMARY KEY ("userId","courseId","role")
);
...
-- AddForeignKey
ALTER TABLE "CourseEnrollments" ADD CONSTRAINT "CourseEnrollments_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "CourseEnrollments" ADD CONSTRAINT "CourseEnrollments_courseId_fkey" FOREIGN KEY ("courseId") REFERENCES "Course"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
